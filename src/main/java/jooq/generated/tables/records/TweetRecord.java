...
public class TweetRecord extends TableRecordImpl<TweetRecord> implements Record5<Integer, String, Timestamp, Integer, Integer> {

	private static final long serialVersionUID = 835791512;
	...
	/**
	 * Setter for <code>public.tweet.player_id</code>.
	 */
	public TweetRecord setPlayerId(Integer value) {
		setValue(3, value);
		return this;
	}

	/**
	 * Getter for <code>public.tweet.player_id</code>.
	 */
	...
	/**
	 * Setter for <code>public.tweet.user_id</code>.
	 */
	public TweetRecord setUserId(Integer value) {
		setValue(4, value);
		return this;
	}

	/**
	 * Getter for <code>public.tweet.user_id</code>.
	 */
	 ...
	 */
	@Override
	public TweetRecord value4(Integer value) {
		setPlayerId(value);
		return this;
	}
	 ...
	 */
	@Override
	public TweetRecord value5(Integer value) {
		setUserId(value);
		return this;
	}
	 ...
	 */
	@Override
	public TweetRecord values(Integer value1, String value2, Timestamp value3, Integer value4, Integer value5) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public TweetRecord(Integer tweetId, String message, Timestamp createdTimestamp, Integer playerId, Integer userId) {
		super(Tweet.TWEET);
